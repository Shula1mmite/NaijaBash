...
const categories = [
  {
    ...
    icon: FaHeart,
    image: "https://images.unsplash.com/photo-1534751516642-a1af1efb6e5a", // wedding vibes
    color: "#e73768",
  },
  {
    name: "Burials",
      ...
      <section className="max-w-7xl mx-auto px-6 pt-32 pb-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="animate-fadeUp">
          ...
          <p className="mt-4 text-sm text-black/50 h-5 overflow-hidden">
            <span key={currentMessage} className="block animate-fadeUp">
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-2">
                    <div
                      className="mb-2 p-3 rounded-full bg-white/10 transition-transform group-hover:scale-110"
                      style={{ backgroundColor: `${cat.color}40` }}
                    >
                      <Icon size={35} color={cat.color} />
                    </div>
                    <p className="font-black uppercase text-sm">{cat.name}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-3xl border border-black/10 hover:border-[#69e0f9] transition">
              ...
              <h3 className="text-xl font-semibold mb-6">67 events trending</h3>
            ...
            <div className="p-8 rounded-3xl border border-black/10 hover:border-black transition">
              ...
              <h3 className="text-xl font-semibold mb-6">42 events trending</h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="relative p-10 rounded-3xl border border-black/10 overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-2">Plan & RSVP</h3>
            ...
            <div className="relative p-10 rounded-3xl border border-black/10 overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-2">Show up & vibe</h3>

              <p className="text-black/60 text-sm leading-relaxed">
                Arrive prepared, dressed right, and in the know — because vibes
                matter.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-28">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-black/60 text-lg mb-10">
              Join NaijaBash to RSVP faster, discover invite-only events, and
              host celebrations people actually show up for.
            </p>
